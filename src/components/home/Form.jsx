...
export default class HomeForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = { name: getCookie("username"), roomid: "" };
      ...
      <Form onSubmit={this.handleSubmit}>
        ...
        <FormGroup controlId="formRoomID">
          ...
          <InputGroup className="mb-2">
            ...
            <FormControl placeholder="Room ID" name="roomid" value={this.state.roomid} onChange={this.handleChange} required />
            <InputGroup.Append>
              <Button
                variant="primary" onClick={this.randomizeRoomId}>Random</Button>
            </InputGroup.Append>
          </InputGroup>
        </FormGroup>
